...
;
const metadata = {
    title: "Contact Us - Next Oasis | Get Your Free Quote",
    description: "Get in touch with Next Oasis for web development, mobile app development, UI/UX design, and tech support services. Located in Southampton, UK and Accra, Ghana.",
    keywords: "contact Next Oasis, web development quote, mobile app consultation, digital agency contact, Next Oasis email, Southampton web developers, Accra app developers"
};
